...
import type { SignerStuff } from "../helpers/helpers";
import { getSigner, waitLog } from "../helpers/helpers";
...
async function tokenTransfer<N extends Network>(
  ...
  console.log(quote);
  console.log("Dest token: ", quote.destinationToken.token.address.toString());
